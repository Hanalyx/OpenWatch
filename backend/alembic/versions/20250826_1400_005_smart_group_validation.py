...
def upgrade() -> None:
    ...
    op.add_column('host_groups', sa.Column('os_family', postgresql.ENUM('rhel', 'centos', 'fedora', 'ubuntu', 'debian', 'suse', 'opensuse', 'windows', 'windows_server', 'macos', 'freebsd', 'openbsd', 'solaris', name='os_family_type'), nullable=True))
    ...
    op.add_column('hosts', sa.Column('os_family', postgresql.ENUM('rhel', 'centos', 'fedora', 'ubuntu', 'debian', 'suse', 'opensuse', 'windows', 'windows_server', 'macos', 'freebsd', 'openbsd', 'solaris', name='os_family_type'), nullable=True))
    ...
    op.create_table('group_validation_rules',
        sa.Column('id', postgresql.UUID(as_uuid=True), nullable=False),
        sa.Column('group_id', sa.Integer(), nullable=False),
        sa.Column('rule_type', postgresql.ENUM('os_family_match', 'os_version_match', 'scap_content_compatibility', 'profile_compatibility', 'architecture_match', 'custom_expression', name='group_validation_rule_type'), nullable=False),
    ...
    op.create_table('host_compatibility_cache',
        sa.Column('id', postgresql.UUID(as_uuid=True), nullable=False),
    ...
    op.create_table('group_assignment_history',
        sa.Column('id', postgresql.UUID(as_uuid=True), nullable=False),
        sa.Column('host_id', postgresql.UUID(as_uuid=True), nullable=False),
        sa.Column('group_id', sa.Integer(), nullable=False),
        ...
        sa.ForeignKeyConstraint(['group_id'], ['host_groups.id'], ),
    ...
    op.create_table('scap_content_compatibility',
        sa.Column('id', postgresql.UUID(as_uuid=True), nullable=False),
        sa.Column('content_id', sa.Integer(), nullable=False),
        sa.Column('os_family', postgresql.ENUM('rhel', 'centos', 'fedora', 'ubuntu', 'debian', 'suse', 'opensuse', 'windows', 'windows_server', 'macos', 'freebsd', 'openbsd', 'solaris', name='os_family_type'), nullable=False),
        ...
        sa.PrimaryKeyConstraint('id'),
        sa.UniqueConstraint('content_id', 'os_family', 'os_version_pattern', 'architecture', name='uq_scap_os_compatibility')
    )
    ...
    op.create_table('smart_group_recommendations',
        sa.Column('id', postgresql.UUID(as_uuid=True), nullable=False),
        sa.Column('host_id', postgresql.UUID(as_uuid=True), nullable=False),
        sa.Column('recommended_group_id', sa.Integer(), nullable=True),
        sa.Column('recommendation_type', sa.String(length=50), nullable=False), # 'auto_detected', 'similarity_based', 'content_based'
