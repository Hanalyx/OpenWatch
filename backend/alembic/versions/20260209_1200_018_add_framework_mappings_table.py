...
def upgrade():
    ...
    op.create_index("idx_framework_mappings_framework", "framework_mappings", ["framework"])
    op.create_index(
        "idx_framework_mappings_framework_version",
        "framework_mappings",
        ["framework", "framework_version"],
    )
    op.create_index("idx_framework_mappings_control_id", "framework_mappings", ["control_id"])
    op.create_index("idx_framework_mappings_aegis_rule_id", "framework_mappings", ["aegis_rule_id"])

    # Composite index for framework + control lookups
    op.create_index(
        "idx_framework_mappings_lookup",
        "framework_mappings",
        ["framework", "framework_version", "control_id"],
    )

    # Unique constraint to prevent duplicates
    op.create_index(
        "idx_framework_mappings_unique",
        "framework_mappings",
        ["framework", "framework_version", "control_id", "aegis_rule_id"],
        unique=True,
    )
