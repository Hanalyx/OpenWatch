...
celery_app = Celery(
    "openwatch", broker=broker_url, backend=broker_url, include=[]  # No tasks module for now
)
...
class SecureCeleryManager:
    ...
    def submit_scan_task(
        self, scan_id: int, host_data: dict, content_data: dict, profile_id: str, user_id: int
    ) -> str:
