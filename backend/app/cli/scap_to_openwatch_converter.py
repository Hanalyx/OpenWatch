...
class FrameworkMapper:
    ...
    def __init__(self):
        self.framework_mappings = {
            ...
            "nist": {
                "pattern": r"nist",
                "versions": {"default": "800-53r5", "r4": "800-53r4", "r5": "800-53r5"},
            },
            # CIS mappings
            "cis": {
                "pattern": r"cis",
            ...
            "pci": {
                ...
                "versions": {"default": "v4.0", "v3": "v3.2.1", "v4": "v4.0"},
            },
            # ISO 27001 mappings
            "iso27001": {
                "pattern": r"iso27001",
                "versions": {"default": "2013", "2013": "2013", "2022": "2022"},
            },
            # HIPAA mappings
...
class SCAPToOpenWatchConverter:
    ...
    def convert_all_rules(self) -> ConversionStats:
        ...
        logger.info(
            f"Conversion complete: {self.stats.successfully_converted} successful, {self.stats.conversion_errors} errors"
        )
        return self.stats
