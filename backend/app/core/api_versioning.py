...
class VersionRegistry:
    ...
    def deprecate_version(self, version: str, sunset_date: datetime, migration_guide_url: Optional[str] = None):
...
class VersionMiddleware:
    ...
    async def __call__(self, request: Request, call_next):
        ...
        if api_version.is_deprecated():
            response.headers["Deprecation"] = api_version.deprecation_date.isoformat() if api_version.deprecation_date else "true"
