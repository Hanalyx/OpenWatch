...
class AuthorizationMiddleware(BaseHTTPMiddleware):
    ...
    def __init__(self, app, authorization_service_factory: Callable = None):
        ...
        self.protected_endpoints = {
            ...
            "POST /api/scans/{scan_id}/execute": {
                "resource_type": ResourceType.SCAN,
            ...
            "POST /api/bulk-scans/{session_id}/start": {
                "resource_type": ResourceType.HOST,
                "action": ActionType.EXECUTE,
                "bulk": True,
            },
            "DELETE /api/bulk-scans/{session_id}": {
                "resource_type": ResourceType.HOST,
                "action": ActionType.DELETE,
                "bulk": True,
            },
            ...
            "GET /api/host-groups/{group_id}": {
                "resource_type": ResourceType.HOST_GROUP,
                "action": ActionType.READ,
                "bulk": False,
            },
            "PUT /api/host-groups/{group_id}": {
                "resource_type": ResourceType.HOST_GROUP,
                "action": ActionType.WRITE,
                "bulk": False,
            },
            "DELETE /api/host-groups/{group_id}": {
                "resource_type": ResourceType.HOST_GROUP,
                "action": ActionType.DELETE,
                "bulk": False,
            },
            "POST /api/host-groups/{group_id}/scan": {
                "resource_type": ResourceType.HOST_GROUP,
                "action": ActionType.SCAN,
                "bulk": True,
            },
            ...
            "POST /api/scans/{scan_id}/remediate": {
                "resource_type": ResourceType.SCAN,
                "action": ActionType.EXECUTE,
                "bulk": False,
            },
            "POST /api/bulk-remediate": {
                "resource_type": ResourceType.HOST,
                "action": ActionType.EXECUTE,
                "bulk": True,
            },
