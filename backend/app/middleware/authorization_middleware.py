...
from ..models.authorization_models import (
    ResourceType, ActionType, ResourceIdentifier, AuthorizationContext,
    AuthorizationDecision, BulkAuthorizationRequest
)
...
class AuthorizationMiddleware(BaseHTTPMiddleware):
    ...
    def __init__(self, app, authorization_service_factory: Callable = None):
        ...
        self.protected_endpoints = {
            # Scan operations
            'POST /api/v1/scans': {'resource_type': ResourceType.HOST, 'action': ActionType.SCAN, 'bulk': False},
            'PUT /api/v1/scans/{scan_id}': {'resource_type': ResourceType.SCAN, 'action': ActionType.WRITE, 'bulk': False},
            'DELETE /api/v1/scans/{scan_id}': {'resource_type': ResourceType.SCAN, 'action': ActionType.DELETE, 'bulk': False},
            'GET /api/v1/scans/{scan_id}': {'resource_type': ResourceType.SCAN, 'action': ActionType.READ, 'bulk': False},
            'POST /api/v1/scans/{scan_id}/execute': {'resource_type': ResourceType.SCAN, 'action': ActionType.EXECUTE, 'bulk': False},
            
            # Bulk scan operations - CRITICAL VULNERABILITY PREVENTION
            'POST /api/v1/bulk-scans': {'resource_type': ResourceType.HOST, 'action': ActionType.SCAN, 'bulk': True},
            'POST /api/v1/bulk-scans/{session_id}/start': {'resource_type': ResourceType.HOST, 'action': ActionType.EXECUTE, 'bulk': True},
            'DELETE /api/v1/bulk-scans/{session_id}': {'resource_type': ResourceType.HOST, 'action': ActionType.DELETE, 'bulk': True},
            
            # Host operations
            'GET /api/v1/hosts/{host_id}': {'resource_type': ResourceType.HOST, 'action': ActionType.READ, 'bulk': False},
            'PUT /api/v1/hosts/{host_id}': {'resource_type': ResourceType.HOST, 'action': ActionType.WRITE, 'bulk': False},
            'DELETE /api/v1/hosts/{host_id}': {'resource_type': ResourceType.HOST, 'action': ActionType.DELETE, 'bulk': False},
            'POST /api/v1/hosts/{host_id}/scan': {'resource_type': ResourceType.HOST, 'action': ActionType.SCAN, 'bulk': False},
            
            # Host group operations
            'GET /api/v1/host-groups/{group_id}': {'resource_type': ResourceType.HOST_GROUP, 'action': ActionType.READ, 'bulk': False},
            'PUT /api/v1/host-groups/{group_id}': {'resource_type': ResourceType.HOST_GROUP, 'action': ActionType.WRITE, 'bulk': False},
            'DELETE /api/v1/host-groups/{group_id}': {'resource_type': ResourceType.HOST_GROUP, 'action': ActionType.DELETE, 'bulk': False},
            'POST /api/v1/host-groups/{group_id}/scan': {'resource_type': ResourceType.HOST_GROUP, 'action': ActionType.SCAN, 'bulk': True},
            
            # Rule scanning operations
            'POST /api/v1/rule-scan': {'resource_type': ResourceType.HOST, 'action': ActionType.SCAN, 'bulk': True},
            
            # Remediation operations
            'POST /api/v1/scans/{scan_id}/remediate': {'resource_type': ResourceType.SCAN, 'action': ActionType.EXECUTE, 'bulk': False},
            'POST /api/v1/bulk-remediate': {'resource_type': ResourceType.HOST, 'action': ActionType.EXECUTE, 'bulk': True},
        }
