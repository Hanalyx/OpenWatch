...
class FrameworkMapping(BaseModel):
    ...
    controls: List[str] = Field(
        description="Control IDs for this framework"
    )
    ...
    enhancement_level: Optional[str] = Field(
        default=None,
        description="Level of enhancement over baseline requirements"
    )
    enhancement_details: Optional[str] = Field(
        default=None,
        description="Specific details about how requirements are exceeded"
    )
    gap_analysis: Optional[str] = Field(
        default=None,
        description="Analysis of gaps when status is partial"
    )
    justification: Optional[str] = Field(
        default=None,
        description="Justification for implementation status"
    )
...
class FrameworkVersions(BaseModel):
    ...
    nist_800_53_r5: Optional[FrameworkMapping] = Field(
        default=None,
        description="NIST 800-53 Revision 5 mappings"
    )
    nist_800_53_r4: Optional[FrameworkMapping] = Field(
        default=None,
        description="NIST 800-53 Revision 4 mappings (legacy)"
    )
    cis_v8: Optional[FrameworkMapping] = Field(
        default=None,
        description="CIS Controls v8 mappings"
    )
    cis_v7: Optional[FrameworkMapping] = Field(
        default=None,
        description="CIS Controls v7 mappings (legacy)"
    )
    stig_rhel9: Optional[FrameworkMapping] = Field(
        default=None,
        description="DISA STIG RHEL 9 mappings"
    )
    stig_rhel8: Optional[FrameworkMapping] = Field(
        default=None,
        description="DISA STIG RHEL 8 mappings"
    )
    stig_ubuntu2204: Optional[FrameworkMapping] = Field(
        default=None,
        description="DISA STIG Ubuntu 22.04 mappings"
    )
    stig_ubuntu2404: Optional[FrameworkMapping] = Field(
        default=None,
        description="DISA STIG Ubuntu 24.04 mappings"
    )
    srg_os: Optional[FrameworkMapping] = Field(
        default=None,
        description="SRG Operating System requirements"
    )
    srg_app: Optional[FrameworkMapping] = Field(
        default=None,
        description="SRG Application requirements"
    )
    pci_dss_v4: Optional[FrameworkMapping] = Field(
        default=None,
        description="PCI DSS v4.0 requirements"
    )
    pci_dss_v3: Optional[FrameworkMapping] = Field(
        default=None,
        description="PCI DSS v3.2.1 requirements (legacy)"
    )
    iso_27001_2022: Optional[FrameworkMapping] = Field(
        default=None,
        description="ISO 27001:2022 controls"
    )
    iso_27001_2013: Optional[FrameworkMapping] = Field(
        default=None,
        description="ISO 27001:2013 controls (legacy)"
    )
    hipaa: Optional[FrameworkMapping] = Field(
        default=None,
        description="HIPAA safeguards"
    )
    ccm_v4: Optional[FrameworkMapping] = Field(
        default=None,
        description="Cloud Control Matrix v4"
    )
    fedramp_high: Optional[FrameworkMapping] = Field(
        default=None,
        description="FedRAMP High baseline"
    )
...
class PlatformImplementation(BaseModel):
    ...
    check_command: Optional[str] = Field(
        default=None,
        description="Base command to check rule compliance"
    )
    ...
    kernel_parameters: Optional[Dict[str, Any]] = Field(
        default=None,
        description="Required kernel parameters"
    )
    ...
    reboot_required: bool = Field(
        default=False,
        description="Whether full reboot is required after remediation"
    )
...
class RuleIntelligence(BaseModel):
    ...
    remediation_success_rate: float = Field(
        default=1.0,
        ge=0.0, le=1.0,
        description="Success rate of automated remediation"
    )
    ...
    enhancement_opportunities: List[str] = Field(
        default_factory=list,
        description="Opportunities to enhance this rule"
    )
...
class UnifiedComplianceRule(Document):
    ...
    parent_rule_id: Optional[str] = Field(
        default=None,
        description="For rule inheritance and families"
    )
    ...
    class Settings:
        ...
        indexes = [
            ...
            [("frameworks.nist_800_53_r5.controls", 1), ("frameworks.cis_v8.controls", 1)],
            ...
            [("metadata.name", "text"), ("metadata.description", "text"), ("tags", "text")]
        ]
...
class FrameworkControlDefinition(Document):
    ...
    priority: Optional[str] = Field(
        default=None,
        description="Control priority or baseline"
    )
    ...
    related_controls: List[str] = Field(
        default_factory=list,
        description="Related controls within the same framework"
    )
    external_references: Optional[Dict[str, str]] = Field(
        default=None,
        description="References to external standards"
    )
