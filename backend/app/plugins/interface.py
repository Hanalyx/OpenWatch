...
def create_plugin_metadata(
    name: str, version: str, description: str, author: str, plugin_type: PluginType, **kwargs
) -> PluginMetadata:
...
def create_scan_context(
    scan_id: str, profile_id: str, content_path: str, target_host: str, scan_type: str, **kwargs
) -> ScanContext:
