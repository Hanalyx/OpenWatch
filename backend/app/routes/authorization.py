...
from ..rbac import require_permission, require_admin, Permission
from ..services.authorization_service import get_authorization_service, AuthorizationService
from ..models.authorization_models import (
    ResourceType, ActionType, PermissionEffect, ResourceIdentifier,
    AuthorizationContext, HostPermission, HostGroupPermission
)
...
async def grant_host_permission(
    ...
    try:
        ...
        # Validate actions
        valid_actions = {"read", "write", "execute", "delete", "manage", "scan", "export"}
    ...
    try:
        ...
        return {
            ...
            "recent_activity": {
                ...
                "avg_evaluation_time_ms": float(audit_stats.avg_evaluation_time) if audit_stats.avg_evaluation_time else 0,
