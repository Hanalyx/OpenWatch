...
from ..services.scap_aegis_mapper import SCAPAEGISMapper
...
async def get_rule_scan_history(
    ...
    try:
        ...
        return {"rule_id": rule_id, "scan_history": history, "remediation_guidance": guidance}
    ...
    try:
        ...
        if history_results:
            ...
            if scan_result and scan_result.rule_details:
                ...
                failed_rules = [
                    {"rule_id": rule["rule_id"], "severity": rule.get("severity", "medium")}
        ...
        plan = aegis_mapper.create_remediation_plan(
            scan_id=scan_id, host_id=host_id, failed_rules=failed_rules, platform=platform
        )
