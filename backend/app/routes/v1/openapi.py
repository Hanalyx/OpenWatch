...
@router.get("/postman")
async def get_postman_collection(current_user: dict = Depends(get_current_user)) -> Dict[str, Any]:
    """
    ...
    openapi_spec.update(
        {
            ...
            "servers": [
                ...
                {"url": "https://demo.openwatch.io/api/v1", "description": "Demo Environment"},
            ],
            "externalDocs": {
...
def _get_openapi_tags() -> list:
    ...
    return [
        ...
        {"name": "Host Management v1", "description": "Host inventory and management operations"},
    ...
    openapi_spec["components"]["examples"].update(
        {
            "CapabilitiesResponse": {
                ...
                "value": {
                    ...
                    "integrations": {"aegis_available": False, "container_runtime": "podman"},
                },
            },
