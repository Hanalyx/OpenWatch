...
# validate_ssh_key validates key format and security, extract_ssh_key_metadata extracts fingerprint/type
from .ssh import extract_ssh_key_metadata, validate_ssh_key
    ...
    def _get_legacy_system_default(self) -> Optional[CredentialData]:
        ...
        try:
            ...
            if row:
                ...
                logger.info(
                    "Successfully resolved legacy system default credential for user: ***REDACTED***"
                )
                return credential
