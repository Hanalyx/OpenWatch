...
class SCAPConnectionManager:
    ...
    @classmethod
    def test_connection(cls, hostname: str, port: int, username: str, 
...
class BaseSCAPScanner(ABC):
    ...
    def build_oscap_command(self, profile_id: str, xml_result: Path, 
                           html_report: Path, arf_result: Path,
                           content_path: str, rule_id: str = None) -> List[str]:
