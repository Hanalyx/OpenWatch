...
class BulkScanOrchestrator:
    ...
    def _create_batch_scans(
        self, batch: ScanBatch, session_id: str, name_prefix: str, user_id: str, stagger_delay: int
    ) -> List[str]:
    ...
    async def _validate_bulk_scan_authorization(
        self, user_id: str, host_ids: List[str], auth_context: Optional[AuthorizationContext] = None
