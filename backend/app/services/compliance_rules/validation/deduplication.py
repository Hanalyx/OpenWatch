...
class SmartDeduplicationService:
    ...
    EXCLUDED_FROM_HASH = {
        ...
        "frameworks",  # Compliance framework mappings (NIST, CIS, STIG, etc.) - metadata about standards, not rule logic  # noqa: E501
        "stig",  # STIG-specific metadata (srg_requirement, vuldiscussion, checktext, fixtext) - documentation, not rule logic  # noqa: E501
    }
