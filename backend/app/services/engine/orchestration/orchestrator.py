...
- Kensa compliance engine (app/plugins/kensa/) for compliance scanning
...
class ScanOrchestrator:
    ...
    Use Kensa plugin or BulkScanOrchestrator instead.
    """

    def __init__(self, *args, **kwargs):
        logger.warning("ScanOrchestrator is deprecated. " "Use Kensa plugin or BulkScanOrchestrator instead.")
