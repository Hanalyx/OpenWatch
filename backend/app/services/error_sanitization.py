...
class ErrorSanitizationService:
    ...
    def _log_security_event(
        self, error_data: Dict[str, Any], user_id: Optional[str], source_ip: Optional[str]
    ):
    ...
    def _sanitize_system_info_integration(
        self, system_info: Dict[str, Any], user_id: Optional[str], source_ip: Optional[str]
    ) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            from ..models.system_models import SystemInfoSanitizationContext, SystemInfoLevel
