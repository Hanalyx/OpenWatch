...
Classes:
    ...
    - FrameworkMapping: Framework mapping details
    - ComplianceControl: Unified compliance control across frameworks
...
Example:
    ...
    >>> control = mapper.get_unified_control("xccdf_rule_id")
"""
...
class ComplianceFrameworkMapper:
        ...
        return {
            ...
            "xccdf_mil.disa.stig_rule_SV-230221r792832_rule": [
                FrameworkMapping(
                    ...
                    implementation_guidance=(
                        "Configure SSH daemon to prevent root login by setting "
            ...
            "xccdf_mil.disa.stig_rule_SV-230423r793041_rule": [
                ...
                FrameworkMapping(
                    ...
                    implementation_guidance=(
                        "Collect audit logs from all systems capable of " "generating audit records"
                    ),
                    assessment_objectives=[
                ...
                FrameworkMapping(
                    ...
                    control_family="Audit and Accountability",
                    implementation_guidance=(
                        "Create and retain system audit logs and records to "
                        "monitor, analyze, investigate, and report unlawful "
    ...
    def _infer_nist_control(self, rule_title: str, control_family: str) -> Optional[str]:
        ...
        nist_mappings = {
            ...
            "password": "IA-5",  # Authenticator Management  # pragma: allowlist secret
