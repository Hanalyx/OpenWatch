...
class PluginGovernanceService:
    ...
    async def create_policy(
        ...
        await self._create_audit_event(
            ...
            event_data={"policy_id": policy.policy_id, "policy_type": policy_type.value},
            user_id=created_by
        )
    ...
    async def generate_compliance_report(
        ...
        for plugin in plugins:
            result = await self._evaluate_standard_compliance(plugin, standard, 
                                                             self.compliance_configs.get(standard, {}))
    ...
    async def get_audit_trail(
        ...
        events = await AuditEvent.find(query).sort(
        ...
        try:
            if check_type == "tls_required":
                ...
                return {
                    ...
                    "details": {"actual_license": plugin_license, "approved_licenses": threshold}
                }
