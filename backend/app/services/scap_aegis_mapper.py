...
class SCAPAEGISMapper:
    ...
    def _load_builtin_mappings(self) -> Dict[str, AEGISMapping]:
        ...
        return {
            ...
            "xccdf_mil.disa.stig_rule_SV-230279r792861_rule": AEGISMapping(
                ...
                rollback_commands=[
                    "# No rollback for security permissions"
                ],
    ...
    def create_remediation_plan(self, scan_id: str, host_id: str,
                              failed_rules: List[Dict[str, str]],
                              platform: str = "rhel9") -> RemediationPlan:
    ...
    def _determine_execution_order(self, rule_groups: Dict[str, List[AEGISMapping]], 
        ...
        sorted_categories = sorted(
            rule_groups.keys(),
            key=lambda x: self.category_priorities.get(x, 999)
        )
    ...
    def map_aegis_results_to_scap(self, aegis_job_id: str, 
                                 aegis_results: Dict) -> Dict[str, str]:
    ...
    def get_manual_remediation_steps(self, scap_rule_id: str) -> Optional[Dict]:
        ...
        try:
            ...
            return {
                ...
                "rollback": [
                    {
                        "description": f"Rollback with: {cmd}",
                        "command": cmd
                    }
                    for cmd in mapping.rollback_commands
                ] if mapping.rollback_commands else None
            }
