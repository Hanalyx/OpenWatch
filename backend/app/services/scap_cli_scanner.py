...
class SCAPCLIScanner:
    ...
    async def scan_single_host(self, host_config: Dict, profile_id: str, 
                              content_path: str, rule_id: str = None) -> Dict:
        """
    ...
    async def scan_multiple_hosts(self, hosts_configs: List[Dict], profile_id: str,
                                 content_path: str, rule_id: str = None,
                                 progress_callback = None) -> AsyncGenerator[Dict, None]:
        """
        ...
        scan_tasks = [
            scan_with_semaphore(host_config) 
    ...
    async def batch_scan_from_targets(self, targets: List[str], profile_id: str,
                                    content_path: str, rule_id: str = None,
                                    default_credentials: Dict = None) -> List[Dict]:
        """
        ...
        for target in targets:
            host_config = {
                ...
                'auth_method': default_credentials.get('auth_method', 'password') if default_credentials else 'password',
    ...
    async def _execute_local_scan_async(self, content_path: str, profile_id: str,
    ...
    async def _execute_remote_scan_async(self, hostname: str, port: int, username: str,
