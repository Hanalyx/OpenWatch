        ...
        try:
            ...
            if success:
                ...
                await self.audit_service.log_fix_approval(
                    request_id=request_id, approved_by=approved_by, approval_reason=approval_reason
                )
                ...
                return {"success": True, "message": "Fix execution approved successfully"}
            else:
                return {
                    "success": False,
            ...
            return {"success": False, "message": f"Failed to approve fix execution: {str(e)}"}
