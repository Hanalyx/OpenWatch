...
class SecurityAuditLogger:
    ...
    def _setup_handlers(self):
        ...
        security_handler = RotatingFileHandler(
            security_log_file, maxBytes=100 * 1024 * 1024, backupCount=10, encoding="utf-8"  # 100MB
        )
        ...
        error_handler = RotatingFileHandler(
            error_log_file, maxBytes=50 * 1024 * 1024, backupCount=5, encoding="utf-8"  # 50MB
        )
    ...
    def log_rate_limit_event(
        self, source_ip: str, error_count: int, action_taken: str, user_id: Optional[str] = None
    ):
