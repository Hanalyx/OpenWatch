...
class SecurityConfigManager:
    ...
    def get_effective_config(self, target_id: Optional[str] = None,
                           target_type: Optional[str] = None) -> SecurityPolicyConfig:
        """
    ...
    def set_config(self, scope: ConfigScope, config: SecurityPolicyConfig,
                   target_id: Optional[str] = None, created_by: str = "system") -> bool:
        """
    ...
    def apply_template(self, template_name: str, scope: ConfigScope,
                      target_id: Optional[str] = None, created_by: str = "system") -> bool:
        """
    ...
    def get_config_summary(self, target_id: Optional[str] = None,
