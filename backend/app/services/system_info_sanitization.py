...
from ..models.system_models import (
    SystemInfoLevel, ComplianceSystemInfo, OperationalSystemInfo, AdminSystemInfo,
    SystemInfoSanitizationContext, SystemInfoFilter, SystemInfoMetadata,
    SanitizedSystemValidation, SystemReconnaissancePattern, SystemInfoAuditEvent
)
...
class SystemInfoSanitizationService:
    ...
    def integrate_with_error_sanitization(
        ...
        try:
            ...
            if 'system_info' in error_data:
                fallback_result['system_info'] = {'sanitization_error': True, 'access_level': 'basic'}
    ...
    def _detect_reconnaissance_patterns(
        ...
        if reconnaissance_detected:
            ...
            security_logger.warning(
                ...
                extra={'patterns': triggered_patterns, 'system_info_keys': list(system_info.keys())}
            )
    ...
    def _extract_safe_os_family(self, system_details: str) -> str:
        ...
        if 'linux' in system_details_lower:
            ...
            return 'macOS'
        elif 'freebsd' in system_details_lower or 'openbsd' in system_details_lower or 'netbsd' in system_details_lower or 'unix' in system_details_lower:
            return 'Unix'
        else:
            return 'Unknown'
