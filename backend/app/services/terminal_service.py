...
from ..services.unified_ssh_service import SSHKeyValidationResult, validate_ssh_key
    ...
    async def _get_host_credentials(self) -> tuple[Optional[str], Dict[str, str]]:
        ...
        try:
            ...
            if not credentials and auth_method == "password":
                ...
                test_hosts = {
                    "146.190.45.61": {
                        "username": os.getenv("TEST_HOST_USER", "root"),
                        "password": os.getenv("TEST_HOST_1_PASSWORD"),
                    },
                    "146.190.156.198": {
                        "username": os.getenv("TEST_HOST_USER", "root"),
                        "password": os.getenv("TEST_HOST_2_PASSWORD"),
                    },
                }
