...
class SecureOpsTracer:
    ...
    def trace_database_operation(self, operation: str, table: str):
        ...
        return self.tracer.start_span(
            f"db_{operation}",
            attributes={"db.operation": operation, "db.table": table, "operation.type": "database"},
        )
...
def initialize_tracing(
    service_name: str = "openwatch", service_version: str = "1.0.0", environment: str = "production"
) -> bool:
