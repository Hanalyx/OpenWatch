...
from ..models.error_models import (
    ValidationResultInternal, ValidationResultResponse, 
    ScanErrorInternal, ScanErrorResponse,
    ErrorCategory, ErrorSeverity, AutomatedFix, AutomatedFixResponse
)
        ...
        for error in internal_result.errors:
            ...
            sanitized_error = ScanErrorResponse(
                ...
                automated_fixes=[
                    ...
                    self._sanitize_automated_fix(fix) for fix in error.automated_fixes
                ],
