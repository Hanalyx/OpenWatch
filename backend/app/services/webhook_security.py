...
class WebhookSecurity:
    ...
    def verify_signature(
        ...
        try:
            ...
            logger.error("Error during webhook signature verification", error=str(e), exc_info=True)
            return False
    ...
    def sign_api_request(
        self, method: str, url: str, payload: Optional[Union[Dict[str, Any], str, bytes]] = None
    ) -> Dict[str, str]:
        """
...
def create_webhook_headers(
    payload: Union[Dict[str, Any], str, bytes], event_type: str, delivery_id: Optional[str] = None
) -> Dict[str, str]:
    """
