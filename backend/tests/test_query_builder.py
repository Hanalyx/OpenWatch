...
Tests SQL query construction, parameterization, and security
"""
...
class TestOrderingAndPagination:
    ...
    def test_order_by_invalid_direction_raises_error(self):
...
class TestSQLInjectionPrevention:
    ...
    def test_malicious_search_input(self):
    ...
    def test_malicious_where_value(self):
