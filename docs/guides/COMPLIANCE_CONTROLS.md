...
| Control | Title | OpenWatch Implementation | Evidence |
|---------|-------|-------------------------|----------|
| CM-2 | Baseline Configuration | Kensa YAML rules define expected configurations | The bundled Kensa rule corpus; scan results |
...
| 4.1 | Secure Configuration | Kensa compliance scanning against the bundled rule corpus |
