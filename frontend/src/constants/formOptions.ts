...
export const COMPLIANCE_FRAMEWORK_OPTIONS: Option[] = [
  { value: 'DISA-STIG', label: 'DISA STIG', description: 'Defense Information Systems Agency Security Technical Implementation Guide' },
  { value: 'NIST-800-53', label: 'NIST 800-53', description: 'NIST Security and Privacy Controls for Federal Information Systems' },
  ...
  { value: 'ISO-27001', label: 'ISO 27001', description: 'ISO/IEC 27001 Information Security Management' },
...
export const SCAN_SCHEDULE_OPTIONS: Option[] = [
  ...
  { value: '0 2 * * *', label: 'Daily at 2:00 AM', description: 'Cron expression for daily at 2 AM' },
  { value: '0 2 * * 0', label: 'Weekly on Sunday at 2:00 AM', description: 'Cron expression for weekly on Sunday' },
  { value: '0 2 1 * *', label: 'Monthly on 1st at 2:00 AM', description: 'Cron expression for monthly on first day' },
