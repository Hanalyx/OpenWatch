        ...
        <Container maxWidth="md" sx={{ mt: 4 }}>
          ...
          {state.hostId && hostData && (
            <Alert severity="info" sx={{ mb: 3 }}>
              Ready to scan <strong>{hostData.display_name || hostData.hostname}</strong> using optimized scan templates.
            </Alert>
          )}
        </Container>
      ...
      <Box sx={{ display: 'flex', gap: 3, flexWrap: 'wrap' }}>
        ...
        <Card sx={{ flex: 1, minWidth: 300 }}>
          <CardContent sx={{ p: 3 }}>
            ...
            <Typography variant="body2" color="text.secondary" sx={{ mb: 3 }}>
              Use pre-configured templates for fast, common scans like compliance checks 
              and security audits. Perfect for routine scanning.
            </Typography>
        ...
        <Card sx={{ flex: 1, minWidth: 300 }}>
          <CardContent sx={{ p: 3 }}>
            ...
            <Typography variant="body2" color="text.secondary" sx={{ mb: 3 }}>
              Full control over scan parameters including custom SCAP content, 
              specific profiles, and detailed options. For specialized requirements.
            </Typography>
            
            <Box sx={{ mb: 2 }}>
              <Typography variant="caption" color="text.secondary">
                ✓ Custom SCAP content<br/>
